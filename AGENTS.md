...
This project is indexed by GitNexus as **FleetLogistic** (1340 symbols, 2133 relationships, 58 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
