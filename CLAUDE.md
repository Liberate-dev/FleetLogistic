...
This project is indexed by GitNexus as **FleetLogistic** (1294 symbols, 2130 relationships, 68 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
